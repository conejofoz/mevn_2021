        ...
        methods: {
            ...
            validar(){
                ...
                if(this.email.length > 50){
                    this.validaMensaje.push('El email de proveedor no debe tener mas de 50 caracteres')
                }
            ...
            activar(){
                let me = this
                axios.patch('persona/activate',{'_id':this.adId})
                .then(function(response){
                        me.adModal=0
                        me.adAccion=0
                        me.adNombre=""
            ...
            desactivar(){
                let me = this
                axios.patch('persona/deactivate',{'_id':this.adId})
                .then(function(response){
                        me.adModal=0
                        me.adAccion=0
                        me.adNombre=""
